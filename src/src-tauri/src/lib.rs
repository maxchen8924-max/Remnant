...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            bridge::invoke_scope_detail,
            bridge::invoke_scope_permissions,
            bridge::invoke_scope_set_permission,
            bridge::invoke_scope_visibility,
            bridge::invoke_scope_visibility_upgrade,
            bridge::invoke_safety_evaluate,
            bridge::invoke_safety_policy_get,
